          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <div className="inline-block rounded-lg bg-blue-100 dark:bg-blue-900/50 px-3 py-1 text-sm text-blue-600 dark:text-blue-300 rotate-1">
                <HandwrittenText>Novo: Análise de Competências ENEM</HandwrittenText>
              </div>
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl relative text-foreground">
                ...
                <div className="absolute -top-6 -right-6 text-blue-400 transform rotate-12 hidden md:block">
                  <HandwrittenText className="text-2xl">Fácil e rápido!</HandwrittenText>
                </div>
              </h1>
            ...
            <div className="mx-auto lg:mx-0 relative">
              <div className="relative h-[350px] w-full sm:h-[400px] lg:h-[500px]">
                ...
                <NotebookCard className="absolute top-4 left-4 w-64 h-64 transform -rotate-6 animate-float" highlight>
                  <HandwrittenText color="red" className="text-2xl">
                    Nota: 920/1000
                  </HandwrittenText>
                  <p className="mt-2">Excelente trabalho! Sua argumentação está muito bem estruturada.</p>
                  <div className="mt-4 flex justify-end">
                    <HandwrittenText color="blue">Prof. Carlos</HandwrittenText>
                  </div>
                </NotebookCard>
                  ...
                  <div className="max-w-md mx-auto w-full">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="pt-4 flex justify-between items-center border-t mt-4">
                        ...
                        <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">920</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="mx-auto lg:mx-0 relative">
              <NotebookCard className="transform rotate-3" darkMode>
                <h3 className="text-xl font-bold mb-4 text-blue-300">Lista de Benefícios:</h3>
