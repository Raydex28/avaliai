              ...
              <div className="relative h-[350px] w-full sm:h-[400px] lg:h-[500px]">
                ...
                <NotebookCard className="absolute top-4 left-4 w-64 h-64 transform -rotate-6 animate-float" highlight>
                  ...
                  <div className="mt-4 flex justify-end">
                    <HandwrittenText color="blue">Experimente hoje!</HandwrittenText>
                  </div>
                </NotebookCard>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="mx-auto lg:mx-0 relative">
              <NotebookCard className="transform rotate-3" darkMode>
                <h3 className="text-xl font-bold mb-4 text-blue-300">Comece em 3 passos:</h3>
                <ul className="space-y-4 text-white">
                  <li className="flex items-start gap-3">
                    <div className="bg-blue-800 rounded-full h-7 w-7 flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-bold">1</span>
                    </div>
                    <div>
                      <p className="font-medium">Crie sua conta gratuita</p>
                      <p className="text-sm text-blue-200">Leva apenas alguns segundos</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="bg-blue-800 rounded-full h-7 w-7 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-200">Use a câmera do seu dispositivo</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="bg-blue-800 rounded-full h-7 w-7 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-200">Em segundos, com feedback detalhado</p>
                    </div>
                  </li>
                </ul>
