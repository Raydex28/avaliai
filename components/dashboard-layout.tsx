      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-white dark:bg-slate-800 backdrop-blur supports-[backdrop-filter]:bg-white/90 dark:supports-[backdrop-filter]:bg-slate-800/90">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            {currentClass && (
              <div className="hidden sm:flex items-center ml-4 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full">
                <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Turma: {currentClass.name}</span>
              </div>
            )}
          </div>
