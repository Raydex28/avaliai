...
export function WebsiteLayout({ children }: WebsiteLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <div className="hidden md:block">
                <HandwrittenText color="blue" className="text-sm ml-2 transform -rotate-3">
      ...
      {/* Footer */}
      <footer className="border-t border-border/40 bg-blue-50 dark:bg-slate-900/50">
        <div className="container py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="mt-4">
                <HandwrittenText color="purple">Fale conosco!</HandwrittenText>
              </div>
            </div>
          </div>
